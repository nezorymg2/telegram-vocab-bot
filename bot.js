...
OUTPUT TEMPLATE (ЗАПОЛНИ ТОЧНО КАК ЗДЕСЬ, НИЧЕГО НЕ ПРОПУСКАТЬ):

📊 Анализ текста

🎯 Оценка: X.X/9
📝 Общий отзыв: 2–3 коротких предложения о сильных и слабых сторонах.

❌ "Цитата с ошибкой №1"
✅ "Исправленный вариант №1"
Правило: Коротко и конкретно (1–2 строки).
Ассоциация: 3–10 простых слов.
Пример: Короткое правильное предложение на английском.
...
❌ "Цитата с ошибкой №4"
✅ "Исправленный вариант №4"
Правило: Коротко и конкретно (1–2 строки).
Ассоциация: 3–10 простых слов.
Пример: Короткое правильное предложение на английском.

[При необходимости добавь ещё ошибки №5–№7 в том же формате.]

📝 Пошаговый совет
Правило: Одно конкретное правило из самых частых ошибок текста.
Ассоциация: Простая подсказка для запоминания (3–10 слов).
Примеры:
❌ "Короткая цитата из текста" → ✅ "Исправление"
❌ "Короткая цитата из текста" → ✅ "Исправление"

💡 Что делать дальше
1. Короткий конкретный шаг №1.
2. Короткий конкретный шаг №2.
3. Короткий конкретный шаг №3.

QUALITY CHECK (ОБЯЗАТЕЛЬНО ПРОВЕРЬ ПЕРЕД ВЫВОДОМ):
- Есть ли 4–7 блоков ошибок?
- В каждом блоке заполнены ВСЕ 5 строк (❌, ✅, Правило, Ассоциация, Пример)?
- Нет ли слов "undefined", "null", "N/A", "None", "пусто"?
- "Оценка" в формате X.X/9?
- "Общий отзыв" = 2–3 предложения?
- Есть "Пошаговый совет" и "Что делать дальше"?
- Язык объяснений = русский; предложения-примеры = английский.
— Никогда не оставляй пустые поля. 
— Никогда не выводи "undefined". 
— Если не уверен — пиши "N/A".
`;
