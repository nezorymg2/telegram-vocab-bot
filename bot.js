...
`;
    ...
    if (error.response && error.response.data && error.response.data.error) {
      ...
      const simpleFallback = {
        ...
        errors: [
          {
            from: "когда пользователь пишет",
            to: "исправленная версия",
            rule: "Краткое правило грамматики",
            association: "Ассоциация для запоминания",
            example: "Пример правильного использования"
          }
        ],
        drills: []
      };
